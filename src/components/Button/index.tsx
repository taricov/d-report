export const Button = ({onClickFunc, text, loading, btnFor, color, disabled}:{onClickFunc: () => void, text: string, loading: boolean, btnFor: string, color: string, disabled:boolean}) => {
