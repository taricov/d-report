export const Button = ({onClickFunc, text, loading, btnFor, color}:{onClickFunc: () => void, text: string, loading: boolean, btnFor: string, color: string}) => {
...
<button onClick={onClickFunc} type="button" className={`text-white transition duration-150 shadow-md ${color} font-medium rounded-lg text-sm my-4 px-5 py-2.5 text-center inline-flex items-center outline-none`}>
