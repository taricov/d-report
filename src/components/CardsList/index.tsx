...
const List = ({ children, title, onDragEnd, name }: ListProps) => {
  return (
    <div className="flex flex-col w-6/12 relative"> 
      <h2 className="relative text-xl mx-auto font-bold shadow-md w-fit text-slate-100 rounded-md px-5 py-4 bg-slate-600">{title}
      <button className="absolute top-0 right-10 transform translate-y-0 translate-x-10 transiton hover:bg-slate-400/20 hover:shadow duration-200 fill-slate-200 rounded-md rounded-tl-none rounded-br-none px-[6px] py-[3px]">
