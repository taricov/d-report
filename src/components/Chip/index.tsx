    ...
    <>
     {/* <div className="shadow-lg flex  cursor-pointer py-2  px-3 rounded-md bg-slate-300"> */}
        ...
        {/* {data?.map(d => ( */}
          ...
          <span className={`${tableColor} bg-slate-100 h-fit w-fit text-slate-800 text-xs border border-slate-600/30 font-medium px-2.5 py-0.5 rounded-full capitalize`}>{text.split("_").join(" ")}</span>
          {/* ))} */}
