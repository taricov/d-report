...
<ul className="my-4 space-y-3">
  {Array(10).join().split(",").map((report,i) =>(
    ...
    <li>
<a href="/reports" className="transition duration-200 flex items-center p-3 text-base font-bold text-slate-700 rounded-lg bg-slate-300 hover:bg-slate-400 hover:text-slate-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
